    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-4 mx-auto">
                <h2 class="border text-center mt-3 mb-5 py-3 shadow-sm text-secondary text-capitalize">
                  Latest Posts  : {{ $num }} results
                </h2>
            </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-4 text-center mb-3">
            <div class="card" style="width: 100%;">
                ...
                <div class="card-body">
                    <h5 class="card-title">
                        <a class="text-decoration-none" href="{{ url("/posts/show/{$post->id}") }}">
                            {{$post->title}}
                        </a>
                    </h5>
